...
results_paths = []
choosing_methods_list = ["sa_pause",'pause brute', 'random', 'all users', "fastest ones"]
for choosing_method in choosing_methods_list:

    args = args_parser()
    args.device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    args.method_choosing_users = choosing_method
