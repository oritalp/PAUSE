...
def main():
    ...
    indicating_str = f"users={args.num_users}_alpha={args.alpha}_gamma={args.gamma}_eps_bar={args.epsilon_bar}_eta={args.epsilon_sum_deascent_coeff}_delta_f={args.delta_f}_dir={args.dirichlet_coeff}_seed={args.seed}_iid={args.i_i_d}"
    if args.full_exp:
